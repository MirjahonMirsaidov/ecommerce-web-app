        ...
        try:
            ...
            if parent.status==True:
                variations_list.append({
                    ...
                    "price": parent.price,
                    "image": "http://bahja-api.atomlab.uz:8040" + parent.image.url,
            ...
            for variation in product_variations:
                ...
                "price": variation.price,
                "image": "http://bahja-api.atomlab.uz:8040" + variation.image.url,
                "quantity": variation.quantity,
    ...
    def get(self, request, id):
        try:
            ...
            return Response({
                ...
                "image": "http://bahja-api.atomlab.uz:8040" + product.image.url,
